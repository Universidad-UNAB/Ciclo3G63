    ...
    $.ajax({
        ...
        items.forEach(function (item, index, array) {                
            ...
            registros +=`<tr>
                            ...
                            <td><img class="iconData" src="../../assets/icon/edit-svgrepo-com.svg" onclick='findById(`+item.id+`)'></td>
                            <td><img class="iconData" src="../../assets/icon/delete-bin-svgrepo-com.svg" onclick='deleteById(`+item.id+`)'></td>
                        </tr>`;
        })
